    ...
    <div class="main-container container" id="main-container">         
      ...
      <div class="row">
        ...
        <div class="col-lg-8 blog__content mb-72">
          ...
          <h3 style="font-weight:normal">All Categories <b></b></h3>
		  <br>
            ...
            <div class="col-md-4">
              <article class="entry card">
                <div class="entry__img-holder card__img-holder">
                  <a href="../category/{{str_slug($cat->name_category)}}">
                    <div class="thumb-container thumb-70" style="background:transparent;height:200px">
						<img style=";width:100%;height:auto;width:auto" data-src="{{url('assets/images/category/'.$cat->thumbnail_category)}}" src="{{url('assets/images/category/'.$cat->thumbnail_category)}}" class="entry__img lazyload" alt="" />
					</div>
                  </a>
                </div>

                <div class="text-center entry__body card__body" style="padding:10px">
                  <div class="entry__header">
                    
                    <h2 class="entry__title">
                      <a href="../category/{{str_slug($cat->name_category)}}">
						{{strtoupper($cat->name_category)}}
					  </a>
                    </h2>
                  </div>
                </div>
