@extends("Front.incl.layout")
    ...
    <div class="main-container container" id="main-container">         
      ...
      <div class="row">
		...
		@if($article[0] !== 0)
          <h3 style="font-weight:normal">Keyword: <b>{{ $keyword }}</b></h3>
		  <br>
            ...
            <div class="col-md-4">
              <article class="entry card">
                <div class="entry__img-holder card__img-holder">
                  ...
                  <a href="../category/{{ str_slug($article->name_category) }}" class="entry__meta-category entry__meta-category--label entry__meta-category--align-in-corner entry__meta-category--violet">
		...
		@else
			<h3 style="font-weight:normal">Keyword: <b>( {{ $keyword }} )</b> not found</h3>
			<br>
