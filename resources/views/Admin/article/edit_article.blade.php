		...
		<section class="content">
			<div class="row">
				<div class="box">
					...
					<div class="box-body">
						<div class="col-md-8">							
							<form onsubmit="return copyOriginalText()" action="{{action('Admin\Article@edit_article_action')}}" method="post" enctype="multipart/form-data">
							@csrf
								<input type="hidden" name="id_article" value="{{$article_detail[0]->id_article}}">
								<div class="form-group">
								  <label>Title Artikel</label>
								  <input value="{{$article_detail[0]->title_article}}" required type="text" maxlength="100" class="form-control" name="title_article" placeholder="Insert Title Article">
								</div>
								
								<div class="form-group">
									<label>Content Article</label>
									<br>
									<textarea id="textarea1" rows="15" cols="10" name="content_article">{{$article_detail[0]->content_article}}</textarea>
									<input type="hidden" name="ori_content_article" value="{{$article_detail[0]->ori_content_article}}" id="ori_content_article">
								</div>
								...
								<div class="form-group">
									...
									<label class="ea-file">Choose file
										<input type="file" name="thumbnail_article" id="uploaded1" class="upload" data-value="uploaded1">
									</label>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<br>
									<input required placeholder="Input Tag (separate it with comma)" type="text" value="{{$article_detail[0]->tag_article}}" class="form-control" name="tag_article">
								</div>
								...
								<div class="form-group">
									...
									<br>
									<textarea maxlength="150" style="padding:5px" rows="5" cols="40" name="short_description_article">{{$article_detail[0]->short_description_article}}</textarea>
								</div>
