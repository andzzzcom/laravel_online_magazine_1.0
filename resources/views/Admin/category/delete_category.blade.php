		...
		<section class="content">
			<div class="row">
				<div class="box">
					...
					<div class="box-body">
						<div class="col-md-6">							
							<form action="{{action('Admin\Category@delete_category_action')}}" method="post" enctype="multipart/form-data">
							@csrf
								<input type="hidden" name="id_category" value="{{$category_detail[0]->id_category}}">
								<div class="form-group">
								  <label>Name Category</label>
								  <input disabled type="text" value="{{$category_detail[0]->name_category}}" maxlength="100" class="form-control" name="name_category" placeholder="Insert Category Name">
								</div>
								...
								<div class="form-group">
								  ...
								  <select disabled class="form-control" name="status_category">
