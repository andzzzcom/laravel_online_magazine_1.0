					...
					<div class="box-body">
						<div class="col-md-6">							
							...
							@csrf
								...
								<div class="form-group">
								  <label>Short Description Admin</label>
								  <textarea required class="form-control" name="short_description_admin" placeholder="Insert Admin Short Description">{{$admin_detail[0]->short_description_admin}}</textarea>
								</div>
