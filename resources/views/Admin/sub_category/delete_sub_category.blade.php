	  ...
	  <div class="content-wrapper">
		...
		<section class="content-header">
		  ...
		  <ol class="breadcrumb">
			...
			<li class="active">Remove Subcategory</li>
		  </ol>
		</section>
		...
		<section class="content">
			<div class="row">
				<div class="box">
					...
					<div class="box-body">
						<div class="col-md-6">							
							<form action="{{action('Admin\Category@delete_sub_category_action')}}" method="post" enctype="multipart/form-data">
							@csrf
								...
								<div class="form-group">
								  ...
								  <input disabled value="{{$sub_category_detail[0]->name_sub_category}}" required type="text" maxlength="100" class="form-control" name="name_sub_category" placeholder="Insert Subcategory Name">
								</div>
								...
								<div class="form-group">
								  ...
								  <select disabled class="form-control" name="status_sub_category">
